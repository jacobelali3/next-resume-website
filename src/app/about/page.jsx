    ...
    <div className="pb-4 lg:flex justify-center block md:block mt-14">
      <div className=" lg:w-1/2 sm:w-screen mt-2 px-4">
        ...
        <p className="px-2 text-2xl font-sans mt-6 ">
          ...
          <br></br>
          <br></br>I&apos;m learning both frontend and backend in hopes of
          becoming a full stack. I seek opportunities where I can learn, grow
          ...
          <video
            ...
            loop
            muted
            className="w-full lg:w-80 md:5/12 h-auto mt-8"
          >
